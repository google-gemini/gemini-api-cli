...
func initDeleteCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "delete",
		Short:   "Deletes a credential. Fails if referenced by active triggers.",
		Long:    "Deletes a credential. Fails if referenced by active triggers.",
		Example: "",
		Args:    cobra.NoArgs,
		RunE:    runDeleteCmd,
		Annotations: map[string]string{
			"speakeasy_operation": "DeleteCredential",
		},
	}
...
func runDeleteCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.DeleteCredentialRequest](cmd, deleteCmdMeta, "", "")
	if err != nil {
	...
	res, err := s.Credentials.Delete(cmd.Context(), *req, sdkOpts...)
	if err != nil {
