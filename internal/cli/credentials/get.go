...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "get",
		Short:   "Gets metadata of a single credential (no secret fields).",
		Long:    "Gets metadata of a single credential (no secret fields).",
		Example: "",
		Args:    cobra.NoArgs,
		RunE:    runGetCmd,
		Annotations: map[string]string{
			"speakeasy_operation": "GetCredential",
		},
	}
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.GetCredentialRequest](cmd, getCmdMeta, "", "")
	if err != nil {
	...
	res, err := s.Credentials.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
