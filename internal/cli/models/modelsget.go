...
var modelsGetCmdMeta = []flagutil.FlagMeta{
	{FlagName: "model", Shorthand: "m", FieldPath: "Model", Kind: flagutil.FlagKindString, Required: true, Description: "[required]"},
}
