...
var createCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "base-environment", FieldPath: "Body.BaseEnvironment", Kind: flagutil.FlagKindUnion, Union: &flagutil.UnionMeta{Discriminated: false, Optional: true, TypeDescription: "JSON value (one of: { \"env\": object, \"environment_id\": string, \"network\": object | string | string, \"sources\": object[] } | string)"}},
