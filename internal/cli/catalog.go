	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			values := []map[string]interface{}{
				...
				{"value": "gemini-3.5-flash", "description": "Gemini 3.5 Flash - Our earlier Flash model, built for speed and foundational performance across routine, high-throughput workloads.", "default": false},
				{"value": "gemini-3.6-flash", "description": "Gemini 3.6 Flash - Our previous generation Flash model, balancing speed and multimodal capabilities across general agentic and everyday tasks.", "default": true},
				{"value": "gemini-3.7-flash", "description": "Gemini 3.7 Flash - Our high-speed, efficient Flash model built for everyday coding, agentic tool use, and reliable multi-step execution.", "default": false},
				{"value": "gemini-3.8-flash", "description": "Gemini 3.8 Flash - Our most intelligent Flash model, engineered for long-horizon software engineering, autonomous agents, and complex enterprise workflows.", "default": false},
			...
			fmt.Fprintf(out, "%-42s %s\n", "gemini-3.6-flash (default)", "Gemini 3.6 Flash - Our previous generation Flash model, balancing speed and multimodal capabilities across general agentic and everyday tasks.")
