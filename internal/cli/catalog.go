...
func newModelsCatalogCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "models",
		Short: "List available models and the default",
		Long:  "Curated model list generated from the API schema. The default model is used by \"agent run\" whenever the request body names neither \"model\" nor \"agent\".",
		Args:  cobra.NoArgs,
