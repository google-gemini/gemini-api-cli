...
func initDeleteCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Annotations: map[string]string{
			"speakeasy_operation": "DeleteWebhook",
		},
	}
	flagutil.RegisterFlags(cmd, deleteCmdMeta)
	if err := flagutil.ValidateMeta[operations.DeleteWebhookRequest](deleteCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for delete: %w", err)
	}
	if err := flagutil.DeclarePositionalFlag(cmd, "id", "Required. The ID of the webhook to delete. (or pass it as the [id] argument)", true); err != nil {
		return err
	}
	if err := interactive.Declare(cmd, interactive.CommandSpec{Args: []interactive.ArgSpec{
		{Name: "id", Summary: "Required. The ID of the webhook to delete.", Required: true, SatisfiedBy: []string{"id"}},
	}}); err != nil {
...
func runDeleteCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.DeleteWebhookRequest](cmd, deleteCmdMeta, "", "")
	if err != nil {
	...
	res, err := s.Webhooks.Delete(cmd.Context(), *req, sdkOpts...)
	if err != nil {
