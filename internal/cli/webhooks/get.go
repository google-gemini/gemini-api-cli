...
func initGetCmd(parent *cobra.Command) error {
	...
	if err := flagutil.DeclarePositionalFlag(cmd, "id", "Required. The ID of the webhook to retrieve. (or pass it as the [id] argument)", true); err != nil {
		return err
	}
	if err := interactive.Declare(cmd, interactive.CommandSpec{Args: []interactive.ArgSpec{
		{Name: "id", Summary: "Required. The ID of the webhook to retrieve.", Required: true, SatisfiedBy: []string{"id"}},
	}}); err != nil {
