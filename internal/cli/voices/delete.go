...
var deleteCmdMeta = []flagutil.FlagMeta{
	{FlagName: "id", Shorthand: "i", FieldPath: "ID", Kind: flagutil.FlagKindString, Required: true, Description: "Required. The resource name of the custom stored voice to delete\n(for example, `voices/voice_abc123def456`). [required]"},
}
...
func runDeleteCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Voices.Delete(cmd.Context(), *req, sdkOpts...)
	if err != nil {
