...
var listExecutionsCmdMeta = []flagutil.FlagMeta{
	{FlagName: "trigger-id", Shorthand: "t", FieldPath: "TriggerID", Kind: flagutil.FlagKindString, Required: true, Description: "Resource name of the trigger. [required]"},
	{FlagName: "page-size", FieldPath: "PageSize", Kind: flagutil.FlagKindInt64, Optional: true, Description: "Optional. The maximum number of executions to return per page."},
	{FlagName: "page-token", FieldPath: "PageToken", Kind: flagutil.FlagKindString, Optional: true, Description: "Optional. A page token from a previous ListTriggerExecutions call."},
}
