...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Annotations: map[string]string{
			"speakeasy_operation": "GetTrigger",
		},
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.GetTriggerRequest](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.GetTriggerRequest](cmd, getCmdMeta, "", "")
	if err != nil {
	...
	res, err := s.Triggers.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
