...
func newInternal(rootSDK *GeminiAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Internal {
	return &Internal{
		rootSDK:          rootSDK,
...
// StartUpload - Start an environment file upload
...
func (s *Internal) StartUpload(ctx context.Context, request operations.StartEnvironmentFileUploadRequest, opts ...operations.Option) (*operations.StartEnvironmentFileUploadResponse, error) {
	globals := operations.StartEnvironmentFileUploadGlobals{
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/upload/{api_version}/environments/{environment}/files/{path}", request, globals)
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "StartEnvironmentFileUpload",
		OAuth2Scopes:     nil,
	...
	res := &operations.StartEnvironmentFileUploadResponse{
