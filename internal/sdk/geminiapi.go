...
type GeminiAPI struct {
	...
	// Upload / list / download / delete media (48h TTL)
	Files *Files
	// Full model operations — list and get model metadata, embed, count tokens, and generate with complete request control
	Models *Models
