...
func newEnvironments(rootSDK *GeminiAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Environments {
	return &Environments{
		rootSDK:          rootSDK,
		sdkConfiguration: sdkConfig,
		hooks:            hooks,
		Internal:         newInternal(rootSDK, sdkConfig, hooks),
		Files:            newEnvironmentsFiles(rootSDK, sdkConfig, hooks),
	}
}
...
func (s *Environments) ListEnvironments(ctx context.Context, request *operations.ListEnvironmentsRequest, opts ...operations.Option) (*operations.ListEnvironmentsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/{api_version}/environments", request, globals)
	if err != nil {
	...
	default:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization != nil && *o.SkipDeserialization {
				...
				var out environments.ListEnvironmentsResponse
	...
	default:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization != nil && *o.SkipDeserialization {
				...
				var out environments.Environment
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}
...
func (s *Environments) DeleteEnvironment(ctx context.Context, request operations.DeleteEnvironmentRequest, opts ...operations.Option) (*operations.DeleteEnvironmentResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/{api_version}/environments/{id}", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
