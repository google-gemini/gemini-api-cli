...
func (g GoogleSearchCallArguments) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GoogleSearchCallArguments) UnmarshalJSON(data []byte) error {
...
func (g *GoogleSearchCallArguments) GetQueries() []string {
	if g == nil {
		return nil
	}
	return g.Queries
