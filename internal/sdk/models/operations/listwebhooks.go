...
func (l ListWebhooksGlobals) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListWebhooksGlobals) UnmarshalJSON(data []byte) error {
...
func (l *ListWebhooksGlobals) GetAPIRevision() *string {
	if l == nil {
		return nil
	}
...
func (l *ListWebhooksRequest) GetAPIRevision() *string {
	if l == nil {
		return nil
	}
	return l.APIRevision
