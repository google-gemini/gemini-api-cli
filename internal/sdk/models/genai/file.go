...
// FileState - Output only. Processing state of the File.
type FileState string

const (
	// FileStateStateUnspecified The default value. This value is used if the state is omitted.
	FileStateStateUnspecified FileState = "STATE_UNSPECIFIED"
	// FileStateProcessing File is being processed and cannot be used for inference yet.
	FileStateProcessing FileState = "PROCESSING"
	// FileStateActive File is processed and available for inference.
	FileStateActive FileState = "ACTIVE"
	// FileStateFailed File failed processing.
	FileStateFailed FileState = "FAILED"
)

func (e FileState) ToPointer() *FileState {
	return &e
}

// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *FileState) IsExact() bool {
	if e != nil {
		switch *e {
...
func (f *File) GetState() *FileState {
	if f == nil {
		return nil
	}
	return f.State
