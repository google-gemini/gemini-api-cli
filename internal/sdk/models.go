...
// Models - Full model operations — list and get model metadata, embed, count tokens, and generate with complete request control
type Models struct {
	rootSDK          *GeminiAPI
...
// ModelsList - Lists the [`Model`s](https://ai.google.dev/gemini-api/docs/models/gemini) available through the Gemini API.
...
// ModelsGet - Gets information about a specific `Model` such as its version number, token limits, [parameters](https://ai.google.dev/gemini-api/docs/models/generative-models#model-parameters) and other metadata. Refer to the [Gemini models guide](https://ai.google.dev/gemini-api/docs/models/gemini) for detailed model information.
