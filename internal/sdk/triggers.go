...
// Triggers - Schedule and manage cron triggers that run managed agents
...
func newTriggers(rootSDK *GeminiAPI, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Triggers {
	return &Triggers{
		rootSDK:          rootSDK,
...
func (s *Triggers) List(ctx context.Context, request *operations.ListTriggersRequest, opts ...operations.Option) (*operations.ListTriggersResponse, error) {
	...
	res.Next = func() (*operations.ListTriggersResponse, error) {
		if request == nil {
...
func (s *Triggers) ListExecutions(ctx context.Context, request operations.ListTriggerExecutionsRequest, opts ...operations.Option) (*operations.ListTriggerExecutionsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/{api_version}/triggers/{triggerId}/executions", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
