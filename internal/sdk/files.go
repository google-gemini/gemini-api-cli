...
// Files - Upload / list / download / delete media (48h TTL)
type Files struct {
	rootSDK          *GeminiAPI
...
// FilesList - Lists the metadata for `File`s owned by the requesting project.
...
// FilesGet - Gets the metadata for the given `File`.
