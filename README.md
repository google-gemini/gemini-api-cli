...
```bash
gemini-api environments list --api-key test_api_key --api-version v1beta
...
* [`environments`](docs/gemini-api_environments.md) - Operations for environments
  ...
  * [`internal`](docs/gemini-api_environments_internal.md) - Operations for internal
    * [`start-upload`](docs/gemini-api_environments_internal_start-upload.md) - Start an environment file upload
